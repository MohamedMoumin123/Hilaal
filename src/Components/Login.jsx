...
function AppLogin(props) {
  ...
  const HandleClick = (e) => {
    e.preventDefault();
    if (
      userEmail.current.value == "mohamed@gmail.com" &&
      userPassword.current.value == "123456"
    ) {
      localStorage.setItem("userFname", "mohamed Ali");
      localStorage.setItem("userLname", "Hassan");
      localStorage.setItem("emailData", "mohamed@gmail.com");
      localStorage.setItem("userData", "mohamed");
